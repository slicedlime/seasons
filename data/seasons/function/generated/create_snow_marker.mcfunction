...
execute if block ~ ~ ~ leaf_litter[facing=north,segment_amount=1] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_littern1}, CustomName:'Snowed leaf_littern1'}
execute if block ~ ~ ~ leaf_litter[facing=north,segment_amount=2] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_littern2}, CustomName:'Snowed leaf_littern2'}
execute if block ~ ~ ~ leaf_litter[facing=north,segment_amount=3] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_littern3}, CustomName:'Snowed leaf_littern3'}
execute if block ~ ~ ~ leaf_litter[facing=north,segment_amount=4] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_littern4}, CustomName:'Snowed leaf_littern4'}
execute if block ~ ~ ~ leaf_litter[facing=south,segment_amount=1] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_litters1}, CustomName:'Snowed leaf_litters1'}
execute if block ~ ~ ~ leaf_litter[facing=south,segment_amount=2] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_litters2}, CustomName:'Snowed leaf_litters2'}
execute if block ~ ~ ~ leaf_litter[facing=south,segment_amount=3] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_litters3}, CustomName:'Snowed leaf_litters3'}
execute if block ~ ~ ~ leaf_litter[facing=south,segment_amount=4] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_litters4}, CustomName:'Snowed leaf_litters4'}
execute if block ~ ~ ~ leaf_litter[facing=east,segment_amount=1] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_littere1}, CustomName:'Snowed leaf_littere1'}
execute if block ~ ~ ~ leaf_litter[facing=east,segment_amount=2] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_littere2}, CustomName:'Snowed leaf_littere2'}
execute if block ~ ~ ~ leaf_litter[facing=east,segment_amount=3] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_littere3}, CustomName:'Snowed leaf_littere3'}
execute if block ~ ~ ~ leaf_litter[facing=east,segment_amount=4] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_littere4}, CustomName:'Snowed leaf_littere4'}
execute if block ~ ~ ~ leaf_litter[facing=west,segment_amount=1] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_litterw1}, CustomName:'Snowed leaf_litterw1'}
execute if block ~ ~ ~ leaf_litter[facing=west,segment_amount=2] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_litterw2}, CustomName:'Snowed leaf_litterw2'}
execute if block ~ ~ ~ leaf_litter[facing=west,segment_amount=3] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_litterw3}, CustomName:'Snowed leaf_litterw3'}
execute if block ~ ~ ~ leaf_litter[facing=west,segment_amount=4] align zxy run summon marker ~0.5 ~0.5 ~0.5 {Tags:["_seasons_snow","_seasons_new_snow"], data: {block: leaf_litterw4}, CustomName:'Snowed leaf_litterw4'}
