...
execute if score branch_z_4 _seasons matches -1 positioned ~ ~ ~-4 run function seasons:generated/move/z2
execute if score branch_z_4 _seasons matches 0 run function seasons:generated/move/z2
execute if score branch_z_4 _seasons matches 1 positioned ~ ~ ~4 run function seasons:generated/move/z2
