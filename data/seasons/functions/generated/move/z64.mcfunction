...
execute if score branch_z_64 _seasons matches -1 positioned ~ ~ ~-64 run function seasons:generated/move/z32
execute if score branch_z_64 _seasons matches 0 run function seasons:generated/move/z32
execute if score branch_z_64 _seasons matches 1 positioned ~ ~ ~64 run function seasons:generated/move/z32
