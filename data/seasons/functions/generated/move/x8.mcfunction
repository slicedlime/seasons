...
execute if score branch_x_8 _seasons matches -1 positioned ~-8 ~ ~ run function seasons:generated/move/x4
execute if score branch_x_8 _seasons matches 0 run function seasons:generated/move/x4
execute if score branch_x_8 _seasons matches 1 positioned ~8 ~ ~ run function seasons:generated/move/x4
