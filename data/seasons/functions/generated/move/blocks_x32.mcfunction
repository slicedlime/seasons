...
execute if score branch_x_32 _seasons matches -1 positioned ~-32 ~ ~ run function seasons:generated/move/blocks_x16
execute if score branch_x_32 _seasons matches 0 run function seasons:generated/move/blocks_x16
execute if score branch_x_32 _seasons matches 1 positioned ~32 ~ ~ run function seasons:generated/move/blocks_x16
