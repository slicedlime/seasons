...
execute if score branch_x_2 _seasons matches -1 positioned ~-2 ~ ~ run function seasons:generated/move/x1
execute if score branch_x_2 _seasons matches 0 run function seasons:generated/move/x1
execute if score branch_x_2 _seasons matches 1 positioned ~2 ~ ~ run function seasons:generated/move/x1
