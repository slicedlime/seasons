...
execute if score branch_x_64 _seasons matches -1 positioned ~-64 ~ ~ run function seasons:generated/move/x32
execute if score branch_x_64 _seasons matches 0 run function seasons:generated/move/x32
execute if score branch_x_64 _seasons matches 1 positioned ~64 ~ ~ run function seasons:generated/move/x32
