...
execute if score branch_x_4 _seasons matches -1 positioned ~-4 ~ ~ run function seasons:generated/move/blocks_x2
execute if score branch_x_4 _seasons matches 0 run function seasons:generated/move/blocks_x2
execute if score branch_x_4 _seasons matches 1 positioned ~4 ~ ~ run function seasons:generated/move/blocks_x2
