...
execute if score branch_z_8 _seasons matches -1 positioned ~ ~ ~-8 run function seasons:generated/move/blocks_z4
execute if score branch_z_8 _seasons matches 0 run function seasons:generated/move/blocks_z4
execute if score branch_z_8 _seasons matches 1 positioned ~ ~ ~8 run function seasons:generated/move/blocks_z4
