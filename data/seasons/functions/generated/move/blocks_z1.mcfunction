...
execute if score branch_z_1 _seasons matches -1 positioned ~ ~ ~-1 run function seasons:generated/move/blocks_x64
execute if score branch_z_1 _seasons matches 0 run function seasons:generated/move/blocks_x64
execute if score branch_z_1 _seasons matches 1 positioned ~ ~ ~1 run function seasons:generated/move/blocks_x64
