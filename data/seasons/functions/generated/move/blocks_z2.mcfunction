...
execute if score branch_z_2 _seasons matches -1 positioned ~ ~ ~-2 run function seasons:generated/move/blocks_z1
execute if score branch_z_2 _seasons matches 0 run function seasons:generated/move/blocks_z1
execute if score branch_z_2 _seasons matches 1 positioned ~ ~ ~2 run function seasons:generated/move/blocks_z1
