...
execute if score branch_x_16 _seasons matches -1 positioned ~-16 ~ ~ run function seasons:generated/move/x8
execute if score branch_x_16 _seasons matches 0 run function seasons:generated/move/x8
execute if score branch_x_16 _seasons matches 1 positioned ~16 ~ ~ run function seasons:generated/move/x8
